...
async function extractStreamUrl(url) {
    try {
        ...
        const studioBand = animePlayers.find(player => player.team.name === "Crunchyroll.Subtitles" && player.player === "Animelib" && player.translation_type.label === "Субтитры");

        const subtitles = studioBand.subtitles.find(subtitle => subtitle.format === "vtt");
